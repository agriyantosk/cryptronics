      ...
      >
        ...
        <div class="flex justify-evenly md:flex md:justiy-center md:items-center">
          <button
            ...
            type="button"
            class="px-6 h-10 inline-flex items-center justify-center mb-2 font-medium tracking-wide text-white transition duration-200 rounded-lg shadow-md bg-green-500 hover:bg-green-400 focus:shadow-outline focus:outline-none"
          >
            Calculate
          </button>
          <button
            type="submit"
            class="px-6 h-10 inline-flex items-center justify-center ml-4 mb-2 font-medium tracking-wide text-white transition duration-200 rounded-lg shadow-md bg-green-500 hover:bg-green-400 focus:shadow-outline focus:outline-none"
          >
            Plan trade
          </button>
        </div>
